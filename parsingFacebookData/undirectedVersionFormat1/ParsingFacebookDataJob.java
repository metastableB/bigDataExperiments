...
public class ParsingFacebookDataJob extends BaseJob {
    ...
    // Defining the abstract class objects
        JobInfo jobInfo = new JobInfo() {
            ...
            public Class<?> getJarByClass() {
                return ParsingFacebookDataJob.class;
            }

            @Override
            public Class<? extends Mapper> getMapperClass() {
                return FacebookMapper.class;
            }
            ...
            public Class<? extends Reducer> getReducerClass() {
                return FacebookReducer.class;
            }
        };
       
        return setupJob("facebookParsingJob", jobInfo);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(new Configuration(), new ParsingFacebookDataJob(), args);
        System.exit(res);
    }
